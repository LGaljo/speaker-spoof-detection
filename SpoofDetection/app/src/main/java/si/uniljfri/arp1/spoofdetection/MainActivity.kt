...
import si.uniljfri.arp1.spoofdetection.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private val lowestFreq = 4; // map 85Hz to 0..513
    private val highestFreq = 20; // map 250Hz to 0..513
    ...
    private fun startAudioClassification() {
        ...
        val run = object : Runnable {
            override fun run() {
                ...
                if (!speaking) {
                    runOnUiThread {
                        bindings!!.speechDetected.text = getString(R.string.no_speech_detected)
                    }
                    startTime += classificationInterval
